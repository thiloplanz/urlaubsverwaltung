...
public class SimpleUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) {
        ...
        if (userOptional.isPresent()) {
            ...
            // if INACTIVE we set the Spring User as disabled, expired, and locked
            boolean enabled = !permissions.contains(Role.INACTIVE);

            return new User(person.getLoginName(), person.getPassword(), enabled, enabled, enabled, enabled, grantedAuthorities);
        } else {
